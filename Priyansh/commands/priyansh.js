...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("Owner")==0 || event.body.indexOf("owner")==0 || event.body.indexOf("@owner")==0 || event.body.indexOf("Mani")==0) {
		var msg = {
				body: "Owner profile ✨💖🥀",
				attachment: fs.createReadStream(__dirname + `/noprefix/mani.png`)
			}
